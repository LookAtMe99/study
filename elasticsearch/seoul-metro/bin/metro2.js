...
parse(f1to4, {comment:"#"}, function(csv_err, csv_data){
  ...
  //날짜,역번호,역명,승하차구분,합계,05-06시,06-07시,07-08시,08-09시,09-10시,10-11시,11-12시,12-13시,13-14시,14-15시,15-16시,16-17시,17-18시,18-19시,19-20시,20-21시,21-22시,22-23시,23-24시,24시이후
...
/*
    ...
    //     //console.log(people_out);
        ...
        var fileName = dataIn[0]+"-"+dataIn[1]+".log";
